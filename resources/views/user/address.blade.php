                ...
                <li class="list-group-item d-flex justify-content-between">
                    <p>
                        <span class="text-capitalize"
                              id="location{{$address->id}}">{!! \App\Helper\AddressParser::parseAddress($address) !!}</span>
                    ...
                    <div>
                        <div class="mb-2 d-flex gap-2">
                            ...
                            <a type="button" class="btn btn-secondary" href="/address/{{$address->id}}">Edit</a>
                        </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input value="{{old('postal')}}" class="form-control" type="text" name="postal"
                                       id="street" placeholder="(Optional)">
                            </div>

                            <div class="form-group mb-2">
                                <label for="property" class="form-label">Street Name, building, House No.</label>
                                <input value="{{old('property')}}" class="form-control" type="text" name="property"
