        ...
        <form method="POST" action="/new-address">
            ...
            <div class="row">
                ...
                <div class="form-group mb-2">
                    ...
                    <input value="{{old('postal')}}" class="form-control" type="text" name="postal" id="street"
                           placeholder="(Optional)">
                </div>

                <div class="form-group mb-2">
                    <label for="property" class="form-label">Street Name, building, House No.</label>
                    <input value="{{old('property')}}" class="form-control" type="text" name="property" id="property"
                           required>
                </div>
            ...
            <button type="submit" class="rounded-pill btn btn-primary">Add</button>
        </form>
