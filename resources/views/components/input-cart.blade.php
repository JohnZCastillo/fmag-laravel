            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="input-group">
                        ...
                        <input step="1" name="quantity" type="number" id="cartQuantityInput{{$id}}" class="form-control bg-white border-dark text-dark" placeholder="Quantity" min="{{$min}}" max="{{$max}}" value="1">
